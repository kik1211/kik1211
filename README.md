...
ESP32 C++ • Verilog RTL • Goertzel DSP • TinyML

---

👋 I design and build hardware-software systems spanning low-level C++ embedded firmware, synthesizable Verilog FPGA IP cores, digital signal processing, and memory-constrained TinyML inference.
...
Embedded TinyML proof-of-concept using temporal infrared thermometry and on-device neural-network inference for physiological risk-screening research.
